...
const mentors: Mentor[] = [
  ...
  { name: "Nimisha Chanda", handle: "@NimishaChanda", guidance: "Guidance & support", href: "https://x.com/NimishaChanda" },
  { name: "Aditya G", handle: "@IamAdiG", guidance: "Guidance & support", href: "https://x.com/IamAdiG" },
  { name: "Reddy2Go", handle: "@reddy2go", guidance: "Guidance & support", href: "https://x.com/reddy2go" },
  { name: "Rohit Awasthi", handle: "@rohitawasthi", guidance: "Guidance & support", href: "https://x.com/rohitawasthi" },
  { name: "Raunak Mahajan", handle: "@raunakmahajan", guidance: "Guidance & support", href: "https://x.com/raunakmahajan" },
  { name: "Vivek Shukla", handle: "@vivekshukla", guidance: "Guidance & support", href: "https://x.com/vivekshukla" },
  { name: "Mehul Fanawala", handle: "@MehulFanawala", guidance: "Guidance & support", href: "https://x.com/MehulFanawala" },
  { name: "Fahd Tumbi", handle: "@thefahdtumbi", guidance: "Guidance & support", href: "https://x.com/thefahdtumbi" },
  { name: "Ankur Pandey", handle: "@AnkurPandey", guidance: "Guidance & support", href: "https://x.com/AnkurPandey" },
  { name: "Amit Sethi", handle: "@amit_sethi", guidance: "Guidance & support", href: "https://x.com/amit_sethi" },
  { name: "Kunal Gupta", handle: "@kunal_gupta01", guidance: "Guidance & support", href: "https://x.com/kunal_gupta01" },
  { name: "Kiran Kumar", handle: "@mkirank", guidance: "Guidance & support", href: "https://x.com/mkirank" },
  { name: "Rama Venu", handle: "@ramavenu", guidance: "Guidance & support", href: "https://x.com/ramavenu" },
  { name: "Aditya Vellanki", handle: "@aditya_vellanki", guidance: "Guidance & support", href: "https://x.com/aditya_vellanki" },
  { name: "Prashant Pandya", handle: "@phpandya28", guidance: "Guidance & support", href: "https://x.com/phpandya28" },
  { name: "Bosky", handle: "@0xBosky", guidance: "Guidance & support", href: "https://x.com/0xBosky" },
  { name: "DotSlashTX", handle: "@DotSlashTX", guidance: "Guidance & support", href: "https://x.com/DotSlashTX" },
  { name: "Ronald Wilson", handle: "@RonxldWilson", guidance: "Guidance & support", href: "https://x.com/RonxldWilson" },
  { name: "Akash Bansal", handle: "@akashbnsal", guidance: "Guidance & support", href: "https://x.com/akashbnsal" },
  { name: "Khushi", handle: "@khushhhi_", guidance: "Guidance & support", href: "https://x.com/khushhhi_" },
  { name: "Ramsri Goutham", handle: "@ramsri_goutham", guidance: "Guidance & support", href: "https://x.com/ramsri_goutham" },
  { name: "Grondmaster", handle: "@grondmaster", guidance: "Guidance & support", href: "https://x.com/grondmaster" },
];
